...
class RestaurantMapperImplTest {
    ...
    void deveMapearCreateRestaurantInputDTOParaRestaurant() {
        ...
        assertEquals(dto.cuisineType(), domain.getCuisineType());
        assertEquals(dto.openingHours(), domain.getOpeningHours());
    ...
    void deveMapearRestaurantParaCreateRestaurantOutputDTO() {
        ...
        assertEquals(restaurant.getCuisineType(), dto.cuisineType());
        assertEquals(restaurant.getOpeningHours(), dto.openingHours());
    ...
    void deveMapearListaDeRestaurantParaListaDeGetRestaurantOutputDTO() {
        ...
        assertTrue(dtoList.stream().anyMatch(dto -> dto.name().equals("Restaurante A")));
        assertTrue(dtoList.stream().anyMatch(dto -> dto.name().equals("Restaurante B")));
    }
}
